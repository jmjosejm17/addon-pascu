...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Pascu4/', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Pascu4/art', ''))
cbx_pages = xbmc.translatePath(os.path.join('special://home/userdata/adon_data/plugin.video.Pascu4/art/cbx', ''))
playlists = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.Pascu4/playlists', ''))
tmp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.Pascu4/tmp', ''))
