    ...
    try:
        ...
        if "no longer exists" in data:
            ...
            if video_id == "":
                ...
                body = body.split("&")
                if len(body) >= 0:
                    #http://s103.zerocdn.to/dl/f75f1f2302ac10db475589ef36643de3/5740a9c0/ffdab4200ac9a9c1ea7cbcdfcd06fce8d6.flv?start=0
                    #http://s102.zerocdn.to/dl/754a218b5964501c7db9a56e463d60c4/57408f24/ffdab4200ac9a9c1ea7cbcdfcd06fce8d6.flv?start=0
                    media_url = body[0]#.replace('2.zerocdn.to','3.zerocdn.to')+'?start=0'
